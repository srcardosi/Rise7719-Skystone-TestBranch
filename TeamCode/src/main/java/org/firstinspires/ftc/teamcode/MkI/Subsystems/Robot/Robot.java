...
public class Robot {
    ...
    public final RobotSettings settings;
    ...
    public Robot(OpMode opMode) {
        ...
        settings = new RobotSettings(getClass().getSimpleName());
     ...
     * @param opMode the OpMode that this instance of a robot will be used in.
     */
    public Robot(OpMode opMode, String robotName) {
        this.opMode = opMode;
        telemetry = opMode.telemetry;
        hardwareMap = opMode.hardwareMap;

        settings = new RobotSettings(robotName);
