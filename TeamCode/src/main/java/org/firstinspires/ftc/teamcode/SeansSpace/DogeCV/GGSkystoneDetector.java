...
public class GGSkystoneDetector extends DogeCVDetector {
    ...
    public Rect chooseBestYellow(List<List<Rect>> listOfYellowBlobs) {
    ...
    public Rect chooseBestBlack(List<List<Rect>> listOfBlackBlobs) {
